...
flowchart LR
    ...
    SIG -->|Target Orders| PR[Pre-Trade Risk Gate]
...
- [[Sources/Empirical Market Microstructure by Joel Hasbrouck]] — Microstructure noise and price discovery foundations.
