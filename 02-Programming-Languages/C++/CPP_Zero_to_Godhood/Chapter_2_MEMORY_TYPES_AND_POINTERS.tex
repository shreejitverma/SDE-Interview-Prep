...
\hypertarget{memory-types-and-pointers-1}{%
\chapter{MEMORY, TYPES, AND
POINTERS}\label{memory-types-and-pointers-1}}
...
\subsubsection{2. Storage Class
Specifiers}\label{storage-class-specifiers}}
...
\subsubsection{3. Digit Separators and Binary Literals
