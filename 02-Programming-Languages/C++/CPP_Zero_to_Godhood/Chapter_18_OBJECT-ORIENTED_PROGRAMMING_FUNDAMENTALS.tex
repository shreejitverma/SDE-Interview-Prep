\hypertarget{object-oriented-programming-fundamentals}{%
\chapter{OBJECT-ORIENTED PROGRAMMING
FUNDAMENTALS}\label{object-oriented-programming-fundamentals}}

\hypertarget{classes-objects}{%
\section{Classes \& Objects}\label{classes-objects}}

\hypertarget{basic-class-c98}{%
\subsection{Basic Class (C++98)}\label{basic-class-c98}}
...
\hypertarget{class-member-variables-methods-c98}{%
\subsection{Class Member Variables \& Methods
(C++98)}\label{class-member-variables-methods-c98}}
...
\hypertarget{classes-objects---complete-mastery}{%
\section{Classes \& Objects - Complete
Mastery}\label{classes-objects---complete-mastery}}

\hypertarget{what-is-a-class}{%
\subsection{What is a Class?}\label{what-is-a-class}}

A \textbf{class} is a blueprint for creating objects. It defines: -
\textbf{Attributes} (member variables) - what the object has -
\textbf{Methods} (member functions) - what the object does

\hypertarget{what-is-an-object}{%
\subsection{What is an Object?}\label{what-is-an-object}}

An \textbf{object} is an instance of a class - a concrete entity with
specific values.

\hypertarget{the-four-pillars-of-oop}{%
\section{The Four Pillars of OOP}\label{the-four-pillars-of-oop}}

Object-Oriented Programming is built on four fundamental concepts that
distinguish it from procedural programming:

\hypertarget{encapsulation---data-hiding}{%
\subsection{\texorpdfstring{1. \textbf{Encapsulation} - Data
Hiding}{1. Encapsulation - Data Hiding}}\label{encapsulation---data-hiding}}

\hypertarget{inheritance---code-reuse}{%
\subsection{\texorpdfstring{2. \textbf{Inheritance} - Code
Reuse}{2. Inheritance - Code Reuse}}\label{inheritance---code-reuse}}

\hypertarget{polymorphism---flexible-behavior}{%
\subsection{\texorpdfstring{3. \textbf{Polymorphism} - Flexible
Behavior}{3. Polymorphism - Flexible Behavior}}\label{polymorphism---flexible-behavior}}

\hypertarget{abstraction---simplified-interface}{%
\subsection{\texorpdfstring{4. \textbf{Abstraction} - Simplified
Interface}{4. Abstraction - Simplified Interface}}\label{abstraction---simplified-interface}}
...
\textbf{Encapsulation} is hiding internal details and exposing only
what's necessary.

\hypertarget{access-levels-access-modifiers}{%
\subsection{Access Levels (Access
Modifiers)}\label{access-levels-access-modifiers}}
...
\textbf{Why Encapsulation?} - \textbf{Data Protection}: Prevents invalid
states - \textbf{Control}: You control how data is modified -
\textbf{Flexibility}: Can change internal implementation without
affecting users - \textbf{Security}: Sensitive data is hidden -
\textbf{Maintainability}: Easy to modify implementation later

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{constructors-destructors---complete-guide}{%
\section{Constructors \& Destructors - Complete
Guide}\label{constructors-destructors---complete-guide}}

\hypertarget{types-of-constructors}{%
\subsection{Types of Constructors}\label{types-of-constructors}}
...
\hypertarget{initialization-lists-member-initializer-list}{%
\subsection{Initialization Lists (Member Initializer
List)}\label{initialization-lists-member-initializer-list}}
...
\textbf{Why initialization lists?} - \textbf{Efficiency}: Initializes
variables once (not create then assign) - \textbf{Const members}: Can
only be initialized with initializer list - \textbf{Reference members}:
Must use initializer list - \textbf{Base class initialization}: Only way
to initialize base class

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{inheritance---all-types}{%
\section{Inheritance - All Types}\label{inheritance---all-types}}

\textbf{Inheritance} allows a class to inherit properties and methods
from another class.

\hypertarget{single-inheritance}{%
\subsection{Single Inheritance}\label{single-inheritance}}
...
\hypertarget{multilevel-inheritance}{%
\subsection{Multilevel Inheritance}\label{multilevel-inheritance}}
...
\hypertarget{hierarchical-inheritance}{%
\subsection{Hierarchical Inheritance}\label{hierarchical-inheritance}}
...
\textbf{Polymorphism} means ``many forms'' - the ability of objects to
take multiple forms.

\hypertarget{compile-time-polymorphism-static-polymorphism}{%
\subsection{Compile-Time Polymorphism (Static
Polymorphism)}\label{compile-time-polymorphism-static-polymorphism}}

\hypertarget{function-overloading}{%
\subsubsection{1. Function Overloading}\label{function-overloading}}
...
\subsubsection{2. Operator Overloading}\label{operator-overloading}}
...
\hypertarget{run-time-polymorphism-dynamic-polymorphism}{%
\subsection{Run-Time Polymorphism (Dynamic
Polymorphism)}\label{run-time-polymorphism-dynamic-polymorphism}}

\hypertarget{virtual-functions-override}{%
\subsubsection{Virtual Functions \&
Override}\label{virtual-functions-override}}
...
\hypertarget{abstract-classes-interfaces}{%
\subsubsection{Abstract Classes \&
Interfaces}\label{abstract-classes-interfaces}}
...
\textbf{Abstraction} is showing only essential features and hiding
unnecessary details.
...
\hypertarget{nested-classes}{%
\subsection{Nested Classes}\label{nested-classes}}
...
\hypertarget{inner-classes-with-access-control}{%
\subsection{Inner Classes with Access
Control}\label{inner-classes-with-access-control}}
...
\hypertarget{access-modifiers-friend-classes}{%
\section{Access Modifiers \& Friend
Classes}\label{access-modifiers-friend-classes}}

\hypertarget{public-private-protected}{%
\subsection{Public, Private, Protected}\label{public-private-protected}}
...
\hypertarget{friend-functions-and-classes}{%
\subsection{Friend Functions and
Classes}\label{friend-functions-and-classes}}
...
\hypertarget{static-variables-methods}{%
\subsection{Static Variables \&
Methods}\label{static-variables-methods}}
...
\hypertarget{const-correctness-in-oop}{%
\section{Const Correctness in OOP}\label{const-correctness-in-oop}}
...
\hypertarget{operator-overloading-1}{%
\section{Operator Overloading}\label{operator-overloading-1}}

\hypertarget{overloadable-operators}{%
\subsection{Overloadable Operators}\label{overloadable-operators}}
...
\hypertarget{solid-principles}{%
\section{SOLID Principles}\label{solid-principles}}

\hypertarget{s---single-responsibility-principle}{%
\subsection{S - Single Responsibility
Principle}\label{s---single-responsibility-principle}}
...
\hypertarget{o---openclosed-principle}{%
\subsection{O - Open/Closed Principle}\label{o---openclosed-principle}}
...
\hypertarget{l---liskov-substitution-principle}{%
\subsection{L - Liskov Substitution
Principle}\label{l---liskov-substitution-principle}}
...
\hypertarget{i---interface-segregation-principle}{%
\subsection{I - Interface Segregation
Principle}\label{i---interface-segregation-principle}}
...
\hypertarget{d---dependency-inversion-principle}{%
\subsection{D - Dependency Inversion
Principle}\label{d---dependency-inversion-principle}}
...
\section{Constructors \& Destructors}\label{constructors-destructors}}

\hypertarget{constructors-c98}{%
\subsection{Constructors (C++98)}\label{constructors-c98}}
...
\hypertarget{destructors-c98}{%
\subsection{Destructors (C++98)}\label{destructors-c98}}
...
\hypertarget{advanced-constructor-features-c11}{%
\subsection{2.2 Advanced Constructor Features
(C++11)}\label{advanced-constructor-features-c11}}

\hypertarget{delegating-constructors}{%
\subsubsection{Delegating Constructors}\label{delegating-constructors}}

One constructor can call another constructor of the same class to reduce
code duplication.
...
\hypertarget{inheriting-constructors}{%
\subsubsection{Inheriting Constructors}\label{inheriting-constructors}}

Using \passthrough{\lstinline!using!} to expose base class constructors.
...
\hypertarget{construction-destruction-order}{%
\subsection{2.3 Construction \& Destruction
Order}\label{construction-destruction-order}}

The order is strict and deterministic (Stack logic: LIFO).

\textbf{Construction Order:} 1. Base Classes (in order of inheritance)
2. Member Objects (in order of declaration in class) 3. Constructor Body

\textbf{Destruction Order:} 1. Destructor Body 2. Member Objects
(reverse order of declaration) 3. Base Classes (reverse order of
inheritance)
...
\hypertarget{the-rule-of-three-five-and-zero}{%
\subsection{2.4 The Rule of Three, Five, and
Zero}\label{the-rule-of-three-five-and-zero}}
...
\tightlist
\item
  \textbf{Rule of Three (C++98)}: If you implement one of: Destructor,
  Copy Constructor, Copy Assignment Operator; you likely need to
  implement all three.
\item
  \textbf{Rule of Five (C++11)}: For Move semantics, add Move
  Constructor and Move Assignment Operator.
\item
  \textbf{Rule of Zero}: If your class uses RAII types
  (\passthrough{\lstinline!std::string!},
  \passthrough{\lstinline!std::vector!},
  \passthrough{\lstinline!std::unique\_ptr!}), do \textbf{NOT} declare
  any of the special member functions. Let the compiler generate them.
\end{enumerate}
...
\hypertarget{basic-inheritance-c98}{%
\subsection{Basic Inheritance (C++98)}\label{basic-inheritance-c98}}
...
\hypertarget{multiple-inheritance-c98}{%
\subsection{Multiple Inheritance
(C++98)}\label{multiple-inheritance-c98}}
...
\hypertarget{virtual-functions-c98}{%
\subsection{Virtual Functions (C++98)}\label{virtual-functions-c98}}
...
\hypertarget{advanced-polymorphism}{%
\subsection{2.6 Advanced Polymorphism}\label{advanced-polymorphism}}

\hypertarget{virtual-destructors-critical}{%
\subsubsection{1. Virtual Destructors
(CRITICAL)}\label{virtual-destructors-critical}}

If you delete a derived object through a base pointer, the base
destructor must be virtual. Otherwise, the derived destructor is
\textbf{never called}, causing memory leaks.
...
\hypertarget{covariant-return-types}{%
\subsubsection{2. Covariant Return Types}\label{covariant-return-types}}

An override can return a pointer/reference to a \emph{derived} class,
not just the base.
...
\hypertarget{rtti-dynamic_cast}{%
\subsubsection{3. RTTI \& dynamic\_cast}\label{rtti-dynamic_cast}}

Run-Time Type Information allows safe downcasting. It uses the
\passthrough{\lstinline!vptr!} to check the actual type.
...
\hypertarget{static-polymorphism-crtp}{%
\subsubsection{4. Static Polymorphism
(CRTP)}\label{static-polymorphism-crtp}}

Curiously Recurring Template Pattern. Faster than virtual functions
