...
\chapter{ADVANCED TEMPLATE
METAPROGRAMMING}\label{advanced-template-metaprogramming}}

\hypertarget{advanced-template-metaprogramming-1}{%
\chapter{ADVANCED TEMPLATE
METAPROGRAMMING}\label{advanced-template-metaprogramming-1}}

\hypertarget{the-evolution-of-tmp}{%
\section{1. The Evolution of TMP}\label{the-evolution-of-tmp}}
...
\section{2. SFINAE (Substitution Failure Is Not An
...
\subsection{\texorpdfstring{2.2 The \texttt{void\_t} Trick
...
\section{3. Curiously Recurring Template Pattern
...
\section{4. Policy-Based Design}\label{policy-based-design}}
...
\section{5. Modern TMP with Concepts
