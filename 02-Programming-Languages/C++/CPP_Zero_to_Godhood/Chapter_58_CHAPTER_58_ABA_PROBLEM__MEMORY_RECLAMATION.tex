\hypertarget{chapter-58-aba-problem-memory-reclamation}{%
\section{CHAPTER 58: ABA PROBLEM MEMORY
RECLAMATION}\label{chapter-58-aba-problem-memory-reclamation}}

\hypertarget{aba-problem-memory-reclamation}{%
\section{ABA PROBLEM \& MEMORY
...
\subsubsection{1. The ABA Problem
...
\subsubsection{2. Solution I: Tagged Pointers (Version
...
\subsubsection{3. Solution II: Hazard Pointers (The Gold
...
\subsubsection{4. Solution III: Epoch-Based Reclamation
