...
\chapter{C20 COROUTINES}\label{c20-coroutines}}

\hypertarget{c20-coroutines-1}{%
\chapter{C++20 COROUTINES}\label{c20-coroutines-1}}

\hypertarget{asynchronous-programming}{%
\section{1. Asynchronous Programming}\label{asynchronous-programming}}
...
\subsection{1.1 Keywords}\label{keywords}}
...
\section{2. Generators (The Python
...
\section{4. Under the Hood}\label{under-the-hood}}
