\hypertarget{chapter-56-security-engineering}{%
\section{CHAPTER 56: SECURITY
ENGINEERING}\label{chapter-56-security-engineering}}

\hypertarget{security-engineering}{%
\section{SECURITY ENGINEERING}\label{security-engineering}}

\hypertarget{fuzzing-libfuzzer-afl}{%
\subsubsection{36.1 Fuzzing (libFuzzer /
...
\subsubsection{36.2 Cryptography \& Timing
...
\subsubsection{36.3 Side-Channel Mitigations
