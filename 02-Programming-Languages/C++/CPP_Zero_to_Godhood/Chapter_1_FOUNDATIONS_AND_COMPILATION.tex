\hypertarget{foundations-and-compilation}{%
\chapter{FOUNDATIONS AND
COMPILATION}\label{foundations-and-compilation}}
...
\subsubsection{2. Standard Streams and Buffered
...
\subsubsection{3. Stream State and Error
...
will be evaluated at this point, // and the result is printed. return
0;\\
...
\subsubsection{1. The Build Process (Architectural
...
\subsubsection{2. Linker Symbols and Name
