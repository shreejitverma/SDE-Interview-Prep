---
tags: [security/offensive, security/defensive, reverse-engineering, malware, rootkits, polish, type/moc]
...
> [!summary]
> Dedykowany zbiór 31 zaawansowanych polskich opracowań technicznych i publikacji z zakresu inżynierii wstecznej (reverse engineering), tworzenia kodów powłoki (shellcode), analizy szkodliwego oprogramowania (malware) i rootkitów w systemie GNU/Linux, bezpieczeństwa aplikacji internetowych (seria Michała Sajdaka / Sekurak / Niebezpiecznik), mandatory access control (SELinux) oraz audytu i administracji systemów linuksowych i bazodanowych.
...
2. **[[Malware-Rootkity-i-Zagrozenia|Malware, Rootkity i Ptrace]]**
   - *Stefan Klaas*: Hakowanie aplikacji: Rootkity i Ptrace.
   - *Mariusz Burdach*: Własny rootkit w GNU/Linuksie (moduły LKM i hooking syscalli).
   - *Rubén Santamarta*: Praktyczna aplikacja do analizy Malware.
   - Monografie: *Robaki sieciowe*, *Rodzaje wirusów komputerowych*, *Wirusy*.
3. **[[Bezpieczenstwo-Web-i-Baz-Danych|Bezpieczeństwo Aplikacji WWW i Baz Danych]]**
   - *Michał Sajdak (2015–2017)*: Czteroczęściowy cykl monograficzny o bezpieczeństwie aplikacji webowych oraz podatnościach w mechanizmach uploadu plików.
...
## Pełny Katalog Plików
- **[[../pl/Index-Polish-Whitepapers|Skorowidz Wszystkich 31 Opracowań Polskich (Index-Polish-Whitepapers.md)]]**

---

## Powiązane Zasoby
- [[../README|Technical Whitepapers Master MOC]]
- [[../base/Index-Base-English-Whitepapers|Katalog Angielski (Base)]]
- [[../ClamAV-Audit-Report|Raport Weryfikacji Antywirusowej ClamAV]]
