...
| C++ Coding Problems | [[14-Low-Latency-Systems/Interview/Coding-Problems-Low-Latency-CPP-Mastery]] |
...
| Title | Author | Focus |
|-------|--------|-------|
| Effective Modern C++ | Scott Meyers | Modern C++ |
...
| A Practical Guide to Quantitative Finance Interviews | Xinfeng Zhou | Probability/brain teasers |
| Heard on The Street | Timothy Crack | Quant interview prep |

## External
| Resource | URL |
|----------|-----|
| QuantNet Forums | https://quantnet.com |
